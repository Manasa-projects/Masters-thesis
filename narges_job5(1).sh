...
#SBATCH --time=10:30:00              #Set the wall clock limit to 1hr and 30min
#SBATCH --ntasks=1                   #Request 1 task
#SBATCH --mem=110000M                  #Request 25600MB (2.5GB) per node
